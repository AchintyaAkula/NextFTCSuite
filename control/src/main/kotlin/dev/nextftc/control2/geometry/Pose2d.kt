...
data class Pose2d(
     ...
     */
    constructor(position: Vector2d<DistanceUnit>, heading: Double) : this(position, Rotation2d.exp(heading))
     ...
     */
    constructor(x: Distance, y: Distance, heading: Angle) : this(Vector2d(x, y), Rotation2d.fromAngle(heading))
     ...
     * @param heading the heading rotation
     */
    constructor(x: Double, y: Double, heading: Rotation2d) : this(Vector2d.displacement(x, y), heading)
