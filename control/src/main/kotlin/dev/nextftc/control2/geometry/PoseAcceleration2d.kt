...
data class PoseAcceleration2d(
     ...
     */
    operator fun plus(pa: PoseAcceleration2d) = PoseAcceleration2d(linearAcc + pa.linearAcc, angAcc + pa.angAcc)
     ...
     */
    operator fun minus(pa: PoseAcceleration2d) = PoseAcceleration2d(linearAcc - pa.linearAcc, angAcc - pa.angAcc)
